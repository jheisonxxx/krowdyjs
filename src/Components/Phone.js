      ...
      numberList.push(
        <tr>
          ...
          <td>{(item.is_main === true) ? '' :
            <button className="btn btn-primary" onClick={() => this.deleteNumber(item.id)}>Eliminar</button>}</td>
          <td>{(item.is_main === true) ? '' :
            <button className="btn btn-primary" onClick={() => this.putPrincipalNumber(item.id, item.number, true)}>
    ...
    return (
      <div>
        ...
        >
          ...
          <br/>
          <br/>
          <button className="btn btn-primary" style="margin-right:10px;" onClick={this.saveNumber}>Guardar</button>
