    ...
    render() {
                ...
                <tr>
                    ...
                    <td>{(item.is_main === true) ? '' :
                        <button className="btn btn-primary"
                                onClick={() => this.deleteEmail(item.id)}>Eliminar</button>}</td>
                    <td>{(item.is_main === true) ? '' :
                        <button className="btn btn-primary"
                                onClick={() => this.putPrincipalEmail(item.id, item.email, true)}>Email
                            Principal</button>}</td>
                </tr>
            )
        });
        ...
        return (
            <div>
                ...
                <button className="btn btn-primary" style={sty_button} onClick={this.openModal}>Agregar Email</button>
                ...
                >
                    ...
                    <br/>
                    <button className="btn btn-primary" style={sty_button} onClick={this.saveEmail}>Guardar</button>
